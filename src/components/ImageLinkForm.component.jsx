...
const button = "rounded outline outline-1 outline-teal-700 px-1 py-2 md:w-1/5 bg-teal-700 text-white"
const buttonMedia = "md:hover:border-teal-700 md:hover:bg-white md:hover:text-teal-700"
