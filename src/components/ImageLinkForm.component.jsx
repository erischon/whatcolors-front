...
const inputUrl = "rounded px-1 py-2 outline outline-1 outline-offset-1"
const inputUrlMedia = "md:mr-2 md:w-4/5"

const button = "bg-teal-700 text-white px-1 py-2 rounded outline outline-1 outline-teal-700"
